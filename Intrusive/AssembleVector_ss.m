function b = AssembleVector_ss(points, edges, triangles, pde, W, time,ord_in, dim, num_spectral, n_ipce)
...
for triangle = triangles
  ...
  for p = midpoints
    ...
    for i = 1:3
      ...
      integral = feval(pde, 0, v, w, [0;0], dv, dw, dx, 0, x, d, time, 2,ord_in, dim, num_spectral,n_ipce) / 3.0;
...
%   d = edge(5);
  ...
  for p = gausspoints
    ...
    for i = 1:2
      ...
      integral = feval(pde, 0, v, w, [0;0], [0;0], dw, 0, ds, x, d, time, 2,ord_in, dim, num_spectral,n_ipce) / 2.0;
      b(nodes(i)) = b(nodes(i)) + integral;
